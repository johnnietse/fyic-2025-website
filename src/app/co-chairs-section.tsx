...
export function CoChairsSection() {
  return (
    <div className="relative w-full bg-white min-h-screen">
      {/* Background image that overlays the white background */}
      <div 
        className="absolute inset-0 min-h-full bg-[url('/image/co-chairs-bg.png')] bg-cover bg-center bg-no-repeat opacity-30"
        style={{ zIndex: 1 }}
      />
      
      <section className="relative z-10 container mx-auto px-4 py-16" style={{ zIndex: 2 }}>
        <div className="h-16"></div> {/* Spacer instead of <br> tags */}
